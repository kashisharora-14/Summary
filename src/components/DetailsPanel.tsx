...
export function DetailsPanel({ entity, caseData }: DetailsPanelProps) {
  return (
    <aside className="flex max-h-[38vh] w-full flex-shrink-0 flex-col overflow-y-auto border-t border-gray-200 bg-white md:max-h-none md:w-80 md:border-l md:border-t-0">
